        ...
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <a class="navbar-brand brand-logo" href="{{ url('/dashboard') }}">
                <img src="{{ URL::asset('assets/images/school.jpg') }}" alt="">
                <span style="font-size: large;"> {{ trans('main_trans.title_dash') }}</span>
            </a>
        <a class="navbar-brand brand-logo-mini" href="{{ url('/dashboard') }}"><img src="{{ URL::asset('assets/images/school.jpg') }}"
                alt=""></a>
            </div>
            <!-- Top bar left -->
             ...
             <div class="btn-group mb-1">
                ...
                <li class="nav-item dropdown mr-30">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" href="#" onclick="event.preventDefault();this.closest('form').submit();"><i class="bx bx-log-out"></i>{{trans('login_trans.Logoff') }} </a>
