    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-title" >
                <div class="row">
                    <div class="col-sm-6" >
                        <h3 class="mb-0" style="font-family: 'Cairo', sans-serif; font-size:35px">{{ trans('main_trans.dashboard') ." ". trans('login_trans.admin')}}</h3>
                        <hr>
                    </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a href="{{route('students.index')}}" target="_blank"><span class="text-danger">{{ trans('main_trans.view_data') }}</span></a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark"> {{trans('main_trans.number') . " " . trans('main_trans.teachers')}} </p>
                                    <h4>{{\App\Models\Teacher::count()}}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a href="{{route('teachers.index')}}" target="_blank"><span class="text-danger">{{ trans('main_trans.view_data') }}</span></a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark"> {{trans('main_trans.number') . " " . trans('main_trans.parents')}}  </p>
                                    <h4>{{\App\Models\MyParent::count()}}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a href="{{url('/admin/add_parent')}}" target="_blank"><span class="text-danger">{{ trans('main_trans.view_data') }}</span></a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark"> {{trans('main_trans.number') . " " . trans('main_trans.classrooms')}} </p>
                                    <h4>{{\App\Models\Section::count()}}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a href="{{route('sections.index')}}" target="_blank"><span class="text-danger">{{ trans('main_trans.view_data') }}</span></a>
                            </p>
                        </div>
                    </div>
                </div>
