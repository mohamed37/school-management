<!DOCTYPE html>
<html lang="en">
    @section('title') {{ trans('main_trans.students') }} @endsection
<head>
    <meta charset="utf-8">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
             ...
             <div class="page-title" >
                <div class="row">
                    <div class="col-sm-6" >
                        <h4 class="mb-0" style="font-family: 'Cairo', sans-serif">{{ trans('main_trans.dashboard') ." ". trans('login_trans.student')}}</h4>
                    </div>
                    <div class="col-sm-6">
