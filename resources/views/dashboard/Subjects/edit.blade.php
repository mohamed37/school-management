...
@endsection
{{
    $title = trans('subjects_trans.edit_subject'),
            ...
            <div class="card-body">
                ...
                <div class="col-xs-12">
                    ...
                    <form action="{{route('subjects.update' , 'test')}}" method="post">
                        ...
                        <div class="form-row">
                            <div class="col">
                                <label for="title">{{trans('subjects_trans.name_ar')}}</label>
                            ...
                            <div class="col">
                                <label for="title">{{trans('subjects_trans.name_en')}}</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="teacher_id">
                                        ...
                                        @foreach($teachers as $teacher)
                                            <option  value="{{ $teacher->id }}" {{$subject->teacher_id == $teacher->id ? 'selected' : ''}}>{{ $teacher->name ."[". $teacher->specializations->name ."]"}}</option>
                                        @endforeach
